...
\begin{figure}[H]
    ...
    \hfill
    \subfigure[Nebenschlussmaschine laut Wikipedia ~ \cite{wikipedia:neben}]{\includegraphics[width=0.3\textwidth]{nebenschlusswiki.png}}
    \hfill
...
\begin{figure}[H]
    ...
    \hfill
    \subfigure[Reihenschlussmaschine laut Wikipedia ~ \cite{wikipedia:reihen}]{\includegraphics[width=0.3\textwidth]{reihenschlusswiki.png}}
    \hfill
